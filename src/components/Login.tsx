...
export default function Login() {
    ...
    return (
        <div className="min-h-screen w-full bg-background relative overflow-hidden flex items-center justify-center transition-colors duration-300">
            {/* Background gradient effect - matches the theme */}
            ...
            <div className="absolute right-1/4 bottom-1/4 w-96 h-96 bg-primary/5 rounded-full blur-[100px] animate-pulse delay-1000 opacity-40" />
            ...
            >
                ...
                >
                    <div className="relative group">
                        ...
                        {/* Traveling light beam effect - adapted for theme */}
                        <div className="absolute -inset-[1px] rounded-2xl overflow-hidden pointer-events-none">
                            {/* Top light beam */}
                            <motion.div
                                className="absolute top-0 left-0 h-[3px] w-[50%] bg-gradient-to-r from-transparent via-primary/50 to-transparent opacity-70"
                            ...
                            {/* Right light beam */}
                            <motion.div
                                className="absolute top-0 right-0 h-[50%] w-[3px] bg-gradient-to-b from-transparent via-primary/50 to-transparent opacity-70"
                                initial={{ filter: "blur(2px)" }}
                                animate={{
                                    top: ["-50%", "100%"],
                                    opacity: [0.3, 0.7, 0.3],
                            ...
                            {/* Bottom light beam */}
                            <motion.div
                                className="absolute bottom-0 right-0 h-[3px] w-[50%] bg-gradient-to-r from-transparent via-primary/50 to-transparent opacity-70"
                                initial={{ filter: "blur(2px)" }}
                                animate={{
                                    right: ["-50%", "100%"],
                                    opacity: [0.3, 0.7, 0.3],
                            ...
                            {/* Left light beam */}
                            <motion.div
                                className="absolute bottom-0 left-0 h-[50%] w-[3px] bg-gradient-to-b from-transparent via-primary/50 to-transparent opacity-70"
                                initial={{ filter: "blur(2px)" }}
                                animate={{
                                    bottom: ["-50%", "100%"],
                                    opacity: [0.3, 0.7, 0.3],
                        ...
                        {/* Card border glow */}
                        <div className="absolute -inset-[0.5px] rounded-2xl bg-gradient-to-r from-primary/10 via-primary/30 to-primary/10 opacity-0 group-hover:opacity-70 transition-opacity duration-500" />
                        ...
                        <div className="relative bg-card/80 backdrop-blur-xl rounded-2xl p-6 border border-border shadow-2xl overflow-hidden">
                            ...
                            <div className="text-center space-y-1 mb-5">
                                <motion.div
                                    ...
                                    className="mx-auto w-10 h-10 rounded-full border border-border flex items-center justify-center relative overflow-hidden bg-background/50"
                                >
                                    {/* Logo placeholder */}
                                ...
                                >
                                    Sign in to continue to StrollUp
                                </motion.p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    >
                                        ...
                                        <div className="relative flex items-center overflow-hidden rounded-lg">
                                            ...
                                            <Input
                                                ...
                                                className="w-full bg-background/50 border-input focus:border-primary/50 text-foreground placeholder:text-muted-foreground h-10 transition-all duration-300 pl-10 pr-3 focus:bg-background/80"
                                            />
                                    ...
                                    >
                                        ...
                                        <div className="relative flex items-center overflow-hidden rounded-lg">
                                            ...
                                            <Input
                                                ...
                                                onBlur={() => setFocusedInput(null)}
                                                className="w-full bg-background/50 border-input focus:border-primary/50 text-foreground placeholder:text-muted-foreground h-10 transition-all duration-300 pl-10 pr-10 focus:bg-background/80"
                                            />
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <div className="relative">
                                            <input
                                                ...
                                                className="appearance-none h-4 w-4 rounded border border-border bg-background/50 checked:bg-primary checked:border-primary focus:outline-none focus:ring-1 focus:ring-ring transition-all duration-200"
                                            />
                                            {rememberMe && (
                                                <motion.div
                                ...
                                >
                                    <div className="absolute inset-0 bg-secondary/50 rounded-lg blur opacity-0 group-hover/google:opacity-70 transition-opacity duration-300" />
